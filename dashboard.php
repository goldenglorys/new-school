...
<div class="sidebar">
	<center>
		...
		<?php  echo  "<img src='pics/".$_SESSION['pics']."' class='profile_image'>" ?> 

		<h4 style="background: dodgerblue;padding: 1em;">
	...
	<a href="#" class="wow bounceIn" data-wow-duration="3s">
		<i class="fa fa-info-circle"></i><span>Informations Platform</span>
	</a>

	 <li class="dropdown">
		    <a href="javascript:void(0)" class="dropbtn">
		    	<i class="fa fa-check">Check Students</i>
			</a>
 ...
 -->		       <a href="#" >Sss 3</a>
	...
	<a href="#" class="wow bounceIn" data-wow-duration="3s">
		<i class="fa fa-users"></i><span>Check Teachers</span>
	</a>
...
<!-- 	<a href="#" class="wow bounceIn" data-wow-duration="3s">
	...
	<a href="#" class="wow bounceIn" data-wow-duration="3s" disable>
		<i class="fa fa-info-circle"></i><span>Table</span>
	</a>
